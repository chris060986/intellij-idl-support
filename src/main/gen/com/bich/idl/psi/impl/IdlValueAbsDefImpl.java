...
public class IdlValueAbsDefImpl extends ASTWrapperPsiElement implements IdlValueAbsDef {

  public IdlValueAbsDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitValueAbsDef(this);
  }

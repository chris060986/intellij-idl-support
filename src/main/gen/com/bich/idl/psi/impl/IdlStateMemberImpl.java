...
public class IdlStateMemberImpl extends ASTWrapperPsiElement implements IdlStateMember {

  public IdlStateMemberImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitStateMember(this);
  }

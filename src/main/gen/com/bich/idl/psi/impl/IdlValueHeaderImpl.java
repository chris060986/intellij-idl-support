...
public class IdlValueHeaderImpl extends ASTWrapperPsiElement implements IdlValueHeader {

  public IdlValueHeaderImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitValueHeader(this);
  }
  ...
  public IdlValueKind getValueKind() {
    return findNotNullChildByClass(IdlValueKind.class);
  }

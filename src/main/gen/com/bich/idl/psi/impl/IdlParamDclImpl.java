...
public class IdlParamDclImpl extends ASTWrapperPsiElement implements IdlParamDcl {

  public IdlParamDclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitParamDcl(this);
  }
  ...
  @Override
  @NotNull
  public IdlParamAttribute getParamAttribute() {
    return findNotNullChildByClass(IdlParamAttribute.class);
  }

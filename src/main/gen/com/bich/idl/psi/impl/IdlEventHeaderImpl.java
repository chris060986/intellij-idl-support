...
public class IdlEventHeaderImpl extends ASTWrapperPsiElement implements IdlEventHeader {

  public IdlEventHeaderImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitEventHeader(this);
  }
  ...
  @Override
  @Nullable
  public IdlConnectorDcl getConnectorDcl() {
    return findChildByClass(IdlConnectorDcl.class);
  }

...
public class IdlImportedScopeImpl extends ASTWrapperPsiElement implements IdlImportedScope {

  public IdlImportedScopeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitImportedScope(this);
  }

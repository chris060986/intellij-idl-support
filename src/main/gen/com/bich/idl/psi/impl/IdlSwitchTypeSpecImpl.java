...
public class IdlSwitchTypeSpecImpl extends ASTWrapperPsiElement implements IdlSwitchTypeSpec {

  public IdlSwitchTypeSpecImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitSwitchTypeSpec(this);
  }

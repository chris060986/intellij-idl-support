...
public class IdlPortDclImpl extends ASTWrapperPsiElement implements IdlPortDcl {

  public IdlPortDclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitPortDcl(this);
  }
  ...
  public IdlComponentExport getComponentExport() {
    return findNotNullChildByClass(IdlComponentExport.class);
  }

...
public class IdlComponentExportImpl extends ASTWrapperPsiElement implements IdlComponentExport {

  public IdlComponentExportImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitComponentExport(this);
  }

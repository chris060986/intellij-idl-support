...
public class IdlTypePrefixDclImpl extends ASTWrapperPsiElement implements IdlTypePrefixDcl {

  public IdlTypePrefixDclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitTypePrefixDcl(this);
  }

...
public class IdlReadonlyAttrDeclaratorImpl extends ASTWrapperPsiElement implements IdlReadonlyAttrDeclarator {

  public IdlReadonlyAttrDeclaratorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitReadonlyAttrDeclarator(this);
  }

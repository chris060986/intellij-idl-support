...
public class IdlDestinationTypeImpl extends ASTWrapperPsiElement implements IdlDestinationType {

  public IdlDestinationTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitDestinationType(this);
  }

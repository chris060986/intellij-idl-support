...
public class IdlPublishesDclImpl extends ASTWrapperPsiElement implements IdlPublishesDcl {

  public IdlPublishesDclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitPublishesDcl(this);
  }

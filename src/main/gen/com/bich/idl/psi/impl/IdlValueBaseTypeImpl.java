...
public class IdlValueBaseTypeImpl extends ASTWrapperPsiElement implements IdlValueBaseType {

  public IdlValueBaseTypeImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitValueBaseType(this);
  }

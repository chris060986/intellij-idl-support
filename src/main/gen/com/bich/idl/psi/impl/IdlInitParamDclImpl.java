...
public class IdlInitParamDclImpl extends ASTWrapperPsiElement implements IdlInitParamDcl {

  public IdlInitParamDclImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdlVisitor visitor) {
    visitor.visitInitParamDcl(this);
  }
